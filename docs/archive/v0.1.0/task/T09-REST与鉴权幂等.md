...
> **任务ID**: T09 ｜ **所属里程碑**: [M5-API全能力层](../plan/M5-API全能力层.md) ｜ **状态**: 已完成
> **前置依赖**: [T05](T05-交易员服务.md)–[T08](T08-会话服务与日切.md) ｜ **后置下游**: [T10](T10-WebSocket与实时推送.md)（握手鉴权复用）、[T14](T14-验收与性能基准.md)（UI↔API 对照）
> **设计依据**: [02-后端设计方案](../../../devel/design/02-后端设计方案.md) §2.2 F2/F8、§3.3、§4.1（API-first）、§4.6、§5.1、§5.2、§5.4、§6.3、§6.12 ｜ **最后更新**: 2026-09-17
...
### T09-8 UI↔API 对照准备
- **内容**：按 [01 §7.2 映射表](../../../devel/design/01-前端设计方案.md)输出"UI 能力 → 端点"清单草案，交 [T14-3](T14-验收与性能基准.md) 终审（防能力漂移，§6.12）。
- **交付物**：对照清单草案。
